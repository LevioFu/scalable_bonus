...
def run():
    ...
    parser.add_argument('--input-dir', help='Where to input', type=str)
    parser.add_argument('--output-dir', help='Where to output', type=str)
    #spectroPath = "Spectrogram"
    #audio_fpath = "Trainning"
    ...
    if args.output_dir is None:
        print("Please specify the output dir")
        exit(1)
    ...
    for _file in os.listdir(args.input_dir):
        ...
        X, sr = librosa.load(os.path.join(args.input_dir,_file), sr=44100)
        ...
        plt.savefig(os.path.join(args.output_dir,fileName+'.png'), bbox_inches=None, pad_inches=0)
        plt.close()
